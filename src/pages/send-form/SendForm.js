            ...
            <div class="hidden sm:flex w-full h-[88vh] flex-col items-center justify-center overflow-y-scroll scrollbar-none">
                {
                    (!formSubmitted) ?
                        ...
                        :
                        <div className='flex w-full h-[100%] flex-grow'>
                            <div className='hidden sm:flex w-[50%] h-[75%] flex-col bg-primary min-h-[50%] rounded-xl items-center justify-center p-6'>
