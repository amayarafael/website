    ...
    return (
        <div className='flex sm:hidden flex-col h-[88vh] overflow-y-scroll scrollbar-none'>
            ...
            <div className='flex flex-grow w-full flex-col '>
                <div className='flex flex-col min-h-[350px] w-full items-center justify-center flex-grow'>
                    <FaCircleNodes className='min-w-[25%] h-auto' />
                ...
                <div className='flex flex-col min-h-[350px] w-full items-center justify-center flex-grow'>
                    <FaCheck className='min-w-[25%] h-auto' />
                ...
                <div className='flex flex-col min-h-[350px] w-full items-center justify-center flex-grow'>
                    <FaFingerprint className='min-w-[25%] h-auto' />
                ...
                <div className='flex flex-col min-h-[350px] w-full items-center justify-center flex-grow'>
                    <FaTrophy className='min-w-[25%] h-auto' />
